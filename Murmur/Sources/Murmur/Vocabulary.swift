/// Built-in software-engineering vocabulary, organized by category, injected
/// into the LLM cleanup prompt so the model preserves exact spelling and
/// casing. Not injected for casual mode. Ported verbatim from the Python
/// reference (`src/voiceprompt/vocabulary.py`, VOCABULARY_BY_CATEGORY).
enum Vocabulary {
    static let byCategory: [(category: String, terms: [String])] = [
